...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (21603311)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (21603311)
...
WHERE EXTRACT(YEAR FROM C.drug_era_start_date) - P.year_of_birth > 6
AND EXTRACT(YEAR FROM C.drug_era_end_date) - P.year_of_birth <= 18
