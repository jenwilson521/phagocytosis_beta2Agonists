...
WHERE EXTRACT(YEAR FROM C.condition_start_date) - P.year_of_birth > 18
...
WHERE (EXTRACT(YEAR FROM E.start_date) - P.year_of_birth >= 18 and EXTRACT(YEAR FROM E.start_date) - P.year_of_birth <= 30)
